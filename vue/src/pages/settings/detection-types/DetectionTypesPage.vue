    ...
    <v-card>
      ...
      <v-row dense class="pa-2 align-center">
        ...
        <v-col cols="6" class="d-flex text-right align-center">
          <v-text-field v-model="searchQuery" append-icon="mdi-magnify" class="flex-grow-1 mx-2" solo hide-details dense
            clearable :placeholder="$t('general.search')" @keyup.enter="searchType(searchQuery)"></v-text-field>
      ...
      <v-data-table show-select v-model="selectedTypes" :headers="headers" :items="typeItems" :options.sync="options"
        ...
        <template v-slot:item.action="{ item }">
          <div class="actions">
            <v-btn icon color="primary" :to="`/settings/detection-types/edit/${item.id}`" v-can="'update-type'">
