<template>
  <div class="d-flex flex-column flex-grow-1">
            ...
            <template v-slot:item.type="{ item }">
              <div class="font-weight-bold d-flex align-center text-no-wrap">
                <div v-for="(type, key) in item.types">
                  ...
                  <v-chip
                    class="ma-1"
                    v-else-if="type.trim() === 'people_count'"
                    color="indigo"
                    text-color="white"
                    small
                  >
    ...
    <div
      id="captured_images"
      class="model-aside custom-modal-aside"
              ...
              <v-container fluid>
                <v-row dense>
                    ...
                    <div class="image-cover position-relative">
                      <div class="event-img">
                        <!-- <canvas
                          ...
                          class="mx-auto"
                        ></canvas> -->
                        <img :src="eventOpened.image" alt="" srcset="" />
                        <v-btn
                          icon
                  ...
                  <v-col cols="12">
                    <div class="data-cont">
                      <div>
                        <h6 class="">{{ $t("tables.type") }}</h6>
                        <div class="d-flex">
                          <div
                            class="me-1"
                            v-for="(type, key) in eventOpened.types"
                          >
                            <v-chip
                              class="ma-1"
                              v-if="type === 'throwing_waste'"
  ...
  methods: {
    ...
    toggleFullScreen() {
      ...
      const imgElement = document.querySelector(
        ".custom-modal-aside .event-img img"
      );
