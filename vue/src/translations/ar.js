export default {
  ...
  pageTitles: {
    ...
    settings_mail_template: "Settings - Mail Template",
    settings_mail_server: "Settings - Mail Server",
    settings_sms: "Settings - Sms",
    settings_stations: "Settings - Stations",
    settings_logs: "Settings - Logs",
    "auth-signin": "Login"
  },
  // pageTitles: {
  //   dashboard_analytics: "الرئيسية",
  //   files_list: "الملفات",
  //   users_list: "المستخدمين",
  //   roles_list: "الصلاحيات",
  //   settings_information: "الإعدادات",
  //   settings_properties: "الإعدادات",
  //   settings_theme: "الإعدادات",
  //   settings_mail_template: "الإعدادات - قالب البريد",
  //   settings_mail_server: "الإعدادات - خادم البريد",
  //   settings_sms: "الإعدادات - ",
  //   settings_stations: "الإعدادات - ",
  //   settings_logs: "الإعدادات - السجلات",
  // },
  board: {
  ...
  files: {
    percentage: "النسبة بين الملفات",
    addFile: "إضافة ملف",
    uploadFile: "رفع ملف",
    file: "الملف",
    name: "اسم املف",
    pageDesc: "قم برفع الملفات التي تريد ان تبدا في تحليها",
    tabs: {
      uploaded: "المرفوعة",
      analyzing: "في انتظار التحليل",
      analyzed: "تم التحليل"
    },
    drag: "اسحب الملف الذي تريده في المكان المحدد هنا",
    or: "أو",
    choose: "إختر من هنا"
  },
  menu: {
    ...
    pipesModel: "تحليل النماذج",
    pipesModelAnalysis: "المشاهدات",
    instant_viewing: "المشاهدة اللحظية",
    comparison: "المقارنات",
    indicators: "المؤشرات",
    procedures: "الإجراءات",
    communications: "البلاغات",
  ...
  general: {
    download: "تحميل الملف",
    show_original: "عرض الملف الأصلي",
    show_analyzed: "عرض الملف المحلل",
    allStatus: {
      pending: "في الإنتظار",
      analyzing: "جاري تحليلها",
      analyzed: "تم تحليلها",
      All_Uploads: "كل الملفات",
      all_files_with_dates: "كل الملفات حسب الأيام"
    },
    ...
    total: "الإجمالي",
    smoke: "عدد الاشخاص",
    vehicles: "كشف سرعة المركبات",
    carPaletes: "كشف لوحات السيارات",
    roads: "جودة الطرق",
    fossils: "كشف الحفريات",
    crack: "التصدع",
    people: "الاشخاص",
    leakage: "التسريب",
    wall: "كشف القفز عن الأسوار",
    chemicalLeakage: "التسريب الكيميائي",
    fires: "الحرائق",
    flowers: "كشف التخريب (دهس الزهور)",
    fire: "كشف اماكن تواجد السكوتر الكهربائي",
    scooter: "كشف اماكن تواجد السكوتر الكهربائي",
    ...
    helmet: "خوذة",
    gloves: "قفازات",
    protection_jacket: "سترة الحماية",
    people_count: "عدد الناس",
    throwing_waste: "رمي المخلفات",
    pollution: "التلوث"
  },
  reports: {
  ...
  analyzed: {
    ...
    degrees: "الدرجات",
    university: "الجامعة",
    graduated_at: "تم التخرج في",
    gpa: "المعدل العلمي",
    gpa_from: "المعدل العلمي من",
    ...
    langName: "اللغة",
    proficiency: "المهارة",
    basicsInformation: "المعلومات الاساسية",
    skills: "المهارات",
    work_experience: "الخبرات العملية",
    certifications_or_trainning_courses: "الشهادات والدورات التدريبية",
    languages: "اللغات"
  }
};
