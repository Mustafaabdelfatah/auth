  ...
  >
    ...
    >
      ...
      <template v-slot:prepend>
        <div class="px-2 pt-0 mt-3" style="/*height: 170px*/ margin-top: 10px;">
          <div
            class="title font-weight-bold text-center text-uppercase primary--text "
            style="height: 100%;"
          >
            <!--            {{ product.name }}-->
            <img
              ...
              :src="websiteLogo"
              :alt="websiteName"
              style="width: 90%; height: auto;max-height: 100%;"
            />
          </div>
